...
if (!next) throw new Error("No pending themes. Add more to data.json.");
...
rowIndex: data.themes.indexOf(next),
...
date: new Date(order.created_timestamp * 1000).toISOString().split("T")[0],
